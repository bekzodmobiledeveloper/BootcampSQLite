...
class AsosiyFragment : Fragment(), RecycAdapter.OnMyClickListener {
    ...
    override fun onCreateView(
        ...
        list = myDpHelper.getAllInformation("Asosiy")
    ...
    override fun onEditDelete(position: Int, bootCamp: BootCamp, view: View) {
        val bundle = bundleOf("boot" to bootCamp)
     //   Toast.makeText(requireContext(), bootCamp.id.toString(), Toast.LENGTH_SHORT).show()
        val popupMenu = PopupMenu(binding.root.context, view, Gravity.CENTER)
